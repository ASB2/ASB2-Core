...
public final class UtilFluid {
                            ...
                            if (info.fluid.amount >= amount) {
                                ...
                                if (destination.canDrain(oppositeDirection, info.fluid.getFluid())) {
                                    ...
                                    if (destination.drain(oppositeDirection, info.fluid, false) != null) {
                                        ...
                                        return destination.drain(oppositeDirection, info.fluid, doMove);
                                    }
                                }
                            }
                        }
                        ...
                        if (info.fluid.amount >= amount) {
                            ...
                            if (tank.canDrain(from, info.fluid.getFluid())) {
                                ...
                                if (tank.drain(from, info.fluid, false) != null) {
                                    ...
                                    if (doMove)
                                        tank.drain(from, info.fluid, true);
    ...
    public static boolean removeFluidFromTank(IFluidHandler tank, ForgeDirection from, Fluid fluid, int amount, boolean doMove) {
        ...
        return UtilFluid.removeFluidFromTank(tank, from, new FluidStack(fluid, amount), doMove);
    }
    
    public static boolean removeFluidFromTank(IFluidHandler tank, ForgeDirection from, FluidStack fluid, boolean doMove) {
