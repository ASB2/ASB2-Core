 ...
 * 
 * NB: - output range between 0 and 255 - maximum octave = 7
 * 
 * you can change type of noise between grad & value noise by
 * commenting/uncommenting block you can change type of interpolation between
 * bicubic/bilinear by commenting/uncommenting block
 */
public class FastNoise {
    ...
    public static int noise(double x, double y, int nbOctave) {
        ...
        while (octave != 0) {
            ...
            /*
             * int f24=(bX*bY)>>8; int f23=bX-f24; int f14=bY-f24; int
             * f13=256-f14-f23-f24;
             * 
